...
const UsernameMenu = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="flex flex-col items-center md:w-[170px] w-[120px]">
        <DropdownMenuItem>
        ...
        <Separator />
        <DropdownMenuItem>
          <Button className="flex font-bold bg-orange-400 
                             w-[100px] md:text-lg text-black hover:text-white 
